...
import com.example.amctl.services.accessibility.BoundsData
...
class OverlayManager {
    ...
    fun state(): OverlayState = OverlayState(
        available = AmctlAccessibilityService.instance != null,
        enabled = enabled,
    ...
    private fun runOnMainAndWait(block: () -> Unit) {
        ...
        val service = AmctlAccessibilityService.instance ?: return
